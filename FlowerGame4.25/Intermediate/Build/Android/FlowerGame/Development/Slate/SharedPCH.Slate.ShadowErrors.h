// PCH for C:\Program Files (x86)\Epic Games\UE_4.25\Engine\Source\Runtime\Slate\Public\SlateSharedPCH.h
#define IS_PROGRAM 0
#define UE_GAME 1
...
#include "C:/Program Files (x86)/Epic Games/UE_4.25/Engine/Source/Runtime/Slate/Public/SlateSharedPCH.h"
