...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_FlowerGame, nullptr, "UpdateChoiceShootDelegate__DelegateSignature", nullptr, nullptr, sizeof(_Script_FlowerGame_eventUpdateChoiceShootDelegate_Parms), Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_FlowerGame, nullptr, "UpdateMagDelegate__DelegateSignature", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	uint32 Get_Z_Construct_UEnum_FlowerGame_EGamePlayState_Hash() { return 1973170419U; }
	UEnum* Z_Construct_UEnum_FlowerGame_EGamePlayState()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ETurnAction", (int64)ETurnAction },
				{ "ECaseEvent", (int64)ECaseEvent },
...
static struct FScriptStruct_FlowerGame_StaticRegisterNativesFLines
{
	...
	DEFINE_FUNCTION(AFlowerGameGameModeBase::execGetPlayerFromCase)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(AFlowerGameCharacter**)Z_Param__Result=P_THIS->GetPlayerFromCase(Z_Param_CaseSelected);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AFlowerGameGameModeBase::execShootPlayer)
	{
		P_GET_OBJECT(AFlowerGameCharacter,Z_Param_PlayerDamaged);
		P_GET_PROPERTY(FIntProperty,Z_Param_Damage);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ShootPlayer(Z_Param_PlayerDamaged,Z_Param_Damage);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AFlowerGameGameModeBase::execCheckPlayersInRange)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->CheckPlayersInRange();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AFlowerGameGameModeBase::execFindPlayersInRange)
	{
		P_GET_OBJECT(ACaseDefault,Z_Param_CaseSelected);
		P_GET_PROPERTY(FByteProperty,Z_Param_DirectionMovement);
		P_GET_TARRAY(int32,Z_Param_Range);
		P_GET_PROPERTY(FIntProperty,Z_Param_nbCase);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->FindPlayersInRange(Z_Param_CaseSelected,EDirection(Z_Param_DirectionMovement),Z_Param_Range,Z_Param_nbCase);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AFlowerGameGameModeBase::execLaunchCaseEvent)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->LaunchCaseEvent();
		P_NATIVE_END;
	}
	...
	void AFlowerGameGameModeBase::StaticRegisterNativesAFlowerGameGameModeBase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "CheckPlayersInRange", &AFlowerGameGameModeBase::execCheckPlayersInRange },
			{ "FindPlayersInRange", &AFlowerGameGameModeBase::execFindPlayersInRange },
			{ "GetCurrentState", &AFlowerGameGameModeBase::execGetCurrentState },
			{ "GetPlayerFromCase", &AFlowerGameGameModeBase::execGetPlayerFromCase },
	...
	struct Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFlowerGameGameModeBase, nullptr, "CheckPlayersInRange", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics
	{
		struct FlowerGameGameModeBase_eventFindPlayersInRange_Parms
		{
			ACaseDefault* CaseSelected;
			TEnumAsByte<EDirection> DirectionMovement;
			TArray<int32> Range;
			int32 nbCase;
		};
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CaseSelected;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_DirectionMovement;
		...
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_nbCase;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_CaseSelected = { "CaseSelected", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventFindPlayersInRange_Parms, CaseSelected), Z_Construct_UClass_ACaseDefault_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_DirectionMovement = { "DirectionMovement", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventFindPlayersInRange_Parms, DirectionMovement), Z_Construct_UEnum_FlowerGame_EDirection, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_Range_Inner = { "Range", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_Range = { "Range", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventFindPlayersInRange_Parms, Range), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_nbCase = { "nbCase", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventFindPlayersInRange_Parms, nbCase), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_CaseSelected,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_DirectionMovement,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_Range_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_Range,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::NewProp_nbCase,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFlowerGameGameModeBase, nullptr, "FindPlayersInRange", nullptr, nullptr, sizeof(FlowerGameGameModeBase_eventFindPlayersInRange_Parms), Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics
	{
		struct FlowerGameGameModeBase_eventGetPlayerFromCase_Parms
		{
			ACaseDefault* CaseSelected;
			AFlowerGameCharacter* ReturnValue;
		};
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CaseSelected;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::NewProp_CaseSelected = { "CaseSelected", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventGetPlayerFromCase_Parms, CaseSelected), Z_Construct_UClass_ACaseDefault_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventGetPlayerFromCase_Parms, ReturnValue), Z_Construct_UClass_AFlowerGameCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::NewProp_CaseSelected,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFlowerGameGameModeBase, nullptr, "GetPlayerFromCase", nullptr, nullptr, sizeof(FlowerGameGameModeBase_eventGetPlayerFromCase_Parms), Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFlowerGameGameModeBase, nullptr, "LaunchCaseEvent", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFlowerGameGameModeBase_LaunchCaseEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::NewProp_PlayerDamaged = { "PlayerDamaged", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventShootPlayer_Parms, PlayerDamaged), Z_Construct_UClass_AFlowerGameCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::NewProp_Damage = { "Damage", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FlowerGameGameModeBase_eventShootPlayer_Parms, Damage), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::NewProp_PlayerDamaged,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::NewProp_Damage,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFlowerGameGameModeBase, nullptr, "ShootPlayer", nullptr, nullptr, sizeof(FlowerGameGameModeBase_eventShootPlayer_Parms), Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UClass_AFlowerGameGameModeBase_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Ranges_Inner;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableRange_MetaData[];
#endif
		static void NewProp_bEnableRange_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableRange;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bShowTurnFinishedUI_MetaData[];
#endif
		static void NewProp_bShowTurnFinishedUI_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bShowTurnFinishedUI;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnUpdateMag_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnUpdateMag;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnUpdateChoiceShoot_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnUpdateChoiceShoot;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFlowerGameGameModeBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AFlowerGameGameModeBase_CheckPlayersInRange, "CheckPlayersInRange" }, // 1640037036
		{ &Z_Construct_UFunction_AFlowerGameGameModeBase_FindPlayersInRange, "FindPlayersInRange" }, // 1879185046
		{ &Z_Construct_UFunction_AFlowerGameGameModeBase_GetCurrentState, "GetCurrentState" }, // 665067870
		{ &Z_Construct_UFunction_AFlowerGameGameModeBase_GetPlayerFromCase, "GetPlayerFromCase" }, // 1108381268
		...
		{ &Z_Construct_UFunction_AFlowerGameGameModeBase_ShootPlayer, "ShootPlayer" }, // 2131947731
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges_Inner = { "Ranges", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ARangeWeapon_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges_MetaData[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges = { "Ranges", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFlowerGameGameModeBase, Ranges), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange_MetaData[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	void Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange_SetBit(void* Obj)
	{
		((AFlowerGameGameModeBase*)Obj)->bEnableRange = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange = { "bEnableRange", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFlowerGameGameModeBase), &Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI_MetaData[] = {
		{ "Category", "FlowerGameGameModeBase" },
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	void Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI_SetBit(void* Obj)
	{
		((AFlowerGameGameModeBase*)Obj)->bShowTurnFinishedUI = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI = { "bShowTurnFinishedUI", nullptr, (EPropertyFlags)0x0010000000020005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFlowerGameGameModeBase), &Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateMag_MetaData[] = {
		{ "ModuleRelativePath", "FlowerGameGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateMag = { "OnUpdateMag", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFlowerGameGameModeBase, OnUpdateMag), Z_Construct_UDelegateFunction_FlowerGame_UpdateMagDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateMag_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateMag_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateChoiceShoot = { "OnUpdateChoiceShoot", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFlowerGameGameModeBase, OnUpdateChoiceShoot), Z_Construct_UDelegateFunction_FlowerGame_UpdateChoiceShootDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateChoiceShoot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_OnUpdateChoiceShoot_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFlowerGameGameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_Ranges,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bEnableRange,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlowerGameGameModeBase_Statics::NewProp_bShowTurnFinishedUI,
	...
	IMPLEMENT_CLASS(AFlowerGameGameModeBase, 3354300767);
