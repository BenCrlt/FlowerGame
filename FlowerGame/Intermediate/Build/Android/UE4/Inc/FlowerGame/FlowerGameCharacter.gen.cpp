...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DirectionChooseByUser_MetaData[];
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_DirectionChooseByUser;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFlowerGameCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AFlowerGameCharacter_GoToNextCase, "GoToNextCase" }, // 4284355359
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFlowerGameCharacter_Statics::NewProp_DirectionChooseByUser_MetaData[] = {
		{ "ModuleRelativePath", "Public/Player/FlowerGameCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_AFlowerGameCharacter_Statics::NewProp_DirectionChooseByUser = { "DirectionChooseByUser", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFlowerGameCharacter, DirectionChooseByUser), Z_Construct_UEnum_FlowerGame_EDirection, METADATA_PARAMS(Z_Construct_UClass_AFlowerGameCharacter_Statics::NewProp_DirectionChooseByUser_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlowerGameCharacter_Statics::NewProp_DirectionChooseByUser_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFlowerGameCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlowerGameCharacter_Statics::NewProp_DirectionChooseByUser,
	...
	IMPLEMENT_CLASS(AFlowerGameCharacter, 3621197726);
